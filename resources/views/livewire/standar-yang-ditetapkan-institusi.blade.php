<tr>
    <td class="p-2 border-b border-gray-200">{{ $fakultas_penetapan->penetapan->nama }}</td>
    <td class="p-2 border-b border-gray-200">
        <div class="flex flex-col" x-data="{ open: false }">
            <label class="flex gap-2" for="status_pengaturan_1_{{ $fakultas_penetapan->id }}">
                <div class="modal" x-show="open" x-cloak>
                    <div class="modal-container w-[500px] p-4 py-6">
                        <div class="flex flex-col gap-5">
                            <h3 class="text-md font-bold">{{ $fakultas_penetapan->penetapan->nama }}</h3>
                ...
                <input type="radio" wire:model.live="status_pengaturan.{{ $fakultas_penetapan->id }}" id="status_pengaturan_1_{{ $fakultas_penetapan->id }}" value="1" name="status_pengaturan-{{ $fakultas_penetapan->id }}" x-on:click="open = true">Ada
            </label for="status_pengaturan_0_{{ $fakultas_penetapan->id }}">
            <label class="flex gap-2">
                <input type="radio" wire:model.live="status_pengaturan.{{ $fakultas_penetapan->id }}" wire:click="removeStatusPengaturan()" id="status_pengaturan_0_{{ $fakultas_penetapan->id }}" value="0" name="status_pengaturan-{{ $fakultas_penetapan->id }}">Tidak Ada
            </label>
        </div>
    </td>
    @if ($fakultas_penetapan->tautan)
        <td class="p-2 border-b border-gray-200" align="center"><a href="{{ $fakultas_penetapan->tautan }}" target="_blank" class="flex items-center w-fit gap-1 text-xs py-1 px-3 rounded-md bg-gray-700 text-gray-50"><i class="fa-solid fa-link"></i>Link</a></td>
        <td class="p-2 border-b border-gray-200" align="center">
            @if ($fakultas_penetapan->status_verifikasi == '1')    
        ...
        <td class="p-2 border-b border-gray-200" align="center">
            @if ($fakultas_penetapan->status_dokumen == '1')    
                <span class="text-xs flex gap-2 items-center justify-center px-2 py-1 rounded-full bg-green-500 text-zinc-50" style="font-size: .75em; width: fit-content">
                                ...
                                <div class="px-2">
                                    <table>
                                        <tr>
                                            ...
                                            <td class="py-2 px-1" style="vertical-align: top; overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; white-space: normal;">{{ $fakultas_penetapan->fakultas->nama }}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="py-2 px-1" style="vertical-align: top; overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; white-space: normal;">
                                                <div class="flex items-center gap-2">
                                                    {{ $fakultas_penetapan->status_pengaturan ? 'Ada' : 'Tidak' }}
                                                    {!! $fakultas_penetapan->status_pengaturan ? '<i class="fa-solid fa-check-circle text-green-500"></i>' : '<i class="fa-solid fa-xmark-circle text-red-500"></i>' !!}
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="py-2 px-1" style="vertical-align: top">:</td>
                                            <td class="py-2 px-1" style="vertical-align: top; overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; white-space: normal;">{{ $fakultas_penetapan->catatan }}</td>
                                        </tr>
                                        <tr>
                                            <td class="py-2 px-1" style="vertical-align: top" width="150px">Tautan</td>
                                            <td class="py-2 px-1" style="vertical-align: top">:</td>
                                            <td class="py-2 px-1" style="vertical-align: top; overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; white-space: normal;"><div class="flex flex-wrap gap-2">{{ $fakultas_penetapan->tautan }}<a href="{{ $fakultas_penetapan->tautan }}" target="_blank" class="flex items-center w-fit gap-1 text-xs py-1 px-2 rounded-md bg-gray-700 text-gray-50"><i class="fa-solid fa-link"></i></a></div></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="py-2 px-1" style="vertical-align: top">:</td>
                                            <td class="py-2 px-1" style="vertical-align: top; overflow-wrap: break-word; word-wrap: break-word; word-break: break-all; white-space: normal;">
                                                {{ \Carbon\Carbon::parse($fakultas_penetapan->create_at)->translatedFormat('d F Y') }}
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="flex gap-2 justify-end mt-5">
