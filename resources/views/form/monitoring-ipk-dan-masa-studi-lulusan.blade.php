<x-layout.form>
    ...
    <div class="flex items-center gap-5">
        ...
        <div class="flex flex-col gap-[2px]">
            <h2 class="flex items-center gap-2 text-xl font-semibold text-gray-700">Monitoring IPK dan Masa Studi Lulusan UNPATTI</h2>
    ...
    @livewire('form.monitoring-ipk-dan-masa-studi-lulusan-import', ['fakultas' => request()->route('fakultas'), 'programStudi' => request()->route('programStudi'), 'year' => request()->route('year')])
    
    <hr class="mb-8 border-gray-400 border-dashed">
    
    @livewire('form.monitoring-ipk-dan-masa-studi-lulusan', ['programStudi' => request()->route('programStudi'), 'year' => request()->route('year')])
