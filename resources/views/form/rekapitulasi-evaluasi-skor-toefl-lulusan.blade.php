<x-layout.form>
    ...
    <div class="flex items-center gap-5">
        ...
        <div class="flex flex-col gap-[2px]">
            <h2 class="flex items-center gap-2 text-xl font-semibold text-gray-700">Rekapitulasi Evaluasi Skor Toefl Lulusan UNPATTI</h2>
    ...
    @livewire('form.monitoring-skor-toefl-lulusan', ['programStudi' => request()->route('programStudi'), 'year' => request()->route('year')])
